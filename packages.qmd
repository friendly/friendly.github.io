...
<!-- Experiment: live interactive hex tile via hexsession::make_tile(), embedded directly -->
```{r}
#| echo: false
#| message: false
...
# so hexsession can't auto-discover a logo for it (prompts interactively).
pkgs <- c("heplots", "candisc", "mvinfluence", "genridge", "VisCollin",
          "matlib", "gellipsoid", "ggbiplot", "vcdExtra", "nestedLogit",
