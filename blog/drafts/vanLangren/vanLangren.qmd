...
Sometimes these surprises are more unsettling. The worst is the discovery that we got some piece of the historical record entirely wrong. **Van Langren's Secret**, for an accurate method of determining longitude at sea, is a surprise of the second kind.
Yet, to an amateur historian like myself, telling the story of the surprise itself has a certain
...
of quantitative **data**, rather than a simple table, which was nearly always used at the time.
...
for accurate navigation at sea. In the version of this graph from 1644, you can see how wide
the range of estimates is: over 40% of the range from Toledo to Rome shown.
The arrow underneath marks the actual distance, 16^o31'.

![van Langren's 1644 graph showing 12 estimates of the longitude distance from Toledo to Rome by eminent astronomers.](images/Langren1644.jpg)
...
Here it is in full, exactly as transcribed from page 8---the thing that stumped everyone, including me:
