## Insert A: Where the Heat in "Heat Map" Came From


The wind chill grid above is, technically, a heat map — though nothing about it is hot, which is the first small joke buried in the term. "Heat map" as a word didn't exist until the 1990s, coined by a software designer named Cormac Kinney to describe color-coded grids of financial trading data. Red for losses, green for gains, no actual thermodynamics involved.
...
## Insert C: Telling a Computer What Color You Mean
...
- Friendly, M. (2007), "A.-M. Guerry's Moral Statistics of France: Challenges for Multivariable Spatial Analysis," Statistical Science — https://www.datavis.ca/papers/guerry-STS241.pdf — your own paper, in case readers want the full treatment

- Friendly, M. (2022), "The Life and Works of André-Michel Guerry, Revisited," Sociological Spectrum — https://www.datavis.ca/papers/guerryvie/GuerryLife2-SocSpectrum.pdf
