...
with interruptions in the flow of ideas -> final product. The interruptions are like Bob Dylan's Wild Horses;
...
is all a happy cognitive family in some ways, the way siblings share a last name and a few
...
paragraph or lose it. But more to my main point, each form of writing in my work
...
In this "thinking-about-my-writing-thinking", I'm drawn toJohn McPhee's [*Draft No. 4: On the Writing
Process*](https://us.macmillan.com/books/9780374537975/draftno4/). It is the best
book-length treatment I know of behind this same restlessness about how writing actually
gets done. It takes different shapes in various modes of expression, but there striking similarities.
It's about the tension and friction to move your writing (and software, graphics) closer to
what satisfies you as work well done.
...
* make careful note of the actual image source, for attribution, but also for
  ...
  [davidrumsey.com](https://www.davidrumsey.com/) images, for instance, ship with files
  describing the exact source, reference, and other attributes. Not every source is that
  considerate.)
...
it, and it's exactly what it feels like. One way to handle
