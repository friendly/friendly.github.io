...
None of that existed for `ggplot2`, though, where labeling unusual points is just another geom
you have to wire up yourself, one plot at a time. `heplots::noteworthy()`, and its `ggplot2`
