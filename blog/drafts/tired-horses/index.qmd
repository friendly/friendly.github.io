...
![ Enhanced `ggbiplot` of the crime data, grouping the states by region and adding data ellipses.](figures/fig-crime-biplot3-1.png){fig-align="right" width="40%"}
...
![Biplot of dimensions 3-4 of the Penguin data. Three outliers---noteworthy birds---stand out in this view.](figures/peng-out-biplot-34.png){fig-align="right" width="40%"}
...
The work for me is closely tied to how the images I  find are curated: The wonderful collection of
