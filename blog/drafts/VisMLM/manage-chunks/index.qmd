...
**Which figure chunks still need folding treatment?** (longest few, of 227 --- the highest-payoff targets)
```{r}
#| eval: true
chunks |>
  filter(is_fig, fold_status == "neither") |>
  select(chapter, line, label, n_code_lines) |>
  slice_max(n_code_lines, n = 6)
```
...
**Which chapters have the longest unfolded _figure_ code?**
```{r}
#| eval: true
chunks |>
  filter(is_fig, fold_status == "neither") |>
