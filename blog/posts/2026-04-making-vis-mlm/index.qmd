...
- *Quarto is not LaTeX, however hard it tries* *(coming soon)*:
...
- [*Mind your chunks*](../2026-07-mind-your-chunks/index.qmd) —
  treating `.qmd` files as data: parsing ~670 code chunks into a data frame to audit
  code-folding status and catch lines that overflow the printed page

**Production and permissions**

- [*Getting permissions right (or at least honest)*](../2026-09-tracking-permissions/index.qmd) —
  turning a publisher's six-step image-permissions process into something you can actually track,
  from finding every candidate figure to a spreadsheet an assistant can pick up
