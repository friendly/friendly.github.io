...
## 🗣️ French Has Feelings About Temperature

English collapses distinctions that French insists on keeping separate. The simplest proof: *moite*. That particular warm, slightly damp heaviness that clings to your skin on a Mediterranean afternoon has no English word. "Muggy" is too atmospheric; "clammy" is too cold and unpleasant; "humid" is too meteorological. None of them land on the same spot. *Moite* knows exactly what it means.

The French vocabulary of thermal sensation encodes hedonic valence that English leaves to context. *Tiède* (lukewarm) carries faint disapproval --- a *tiède* reception to your ideas is not a good sign. *Doux* (mild, gentle) flatters the weather. *Étouffant* (stifling) and *brûlant* (burning) escalate past *chaud* the way English "scorching" escalates past "hot" --- but the French get there faster. And *frais* and *froid* are not the same thing: *frais* is pleasantly cool, the word you use for a wine served correctly or a morning breeze that makes you glad to be alive. *Froid* is just cold --- no compliment intended.

The sommelier's *un peu frais* is perhaps the most elegant specimen: "slightly cool," deployed as reassurance, implying that the wine knows what it's doing. It is understatement as aesthetic judgment.

Canadian English has its own thermal poetry, especially in the north and west: *skookum cold* (you *really* better bundle up) among them --- where the sheer physiological extremity of winter demands vocabulary that standard English never had occasion to evolve. Winnipegers, who call their city "Winterpeg," don't even call it "cold" until the temperature plunges below −30°C.

What emerges, cross-linguistically, is a picture consistent with the psychophysics: temperature language is not neutral description. It is evaluation all the way down.
