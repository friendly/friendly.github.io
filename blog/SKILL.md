...
## History of Data Visualization reference material
...
- `vita.bib` (`C:\Users\friendly\Dropbox\localtexmf\bibtex\bib\vita.bib`) — my CV bibliography; usually has better URLs and DOIs than what's on datavis.ca, so check here first when looking for a published-version link
